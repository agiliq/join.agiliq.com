...
class OAuthv2TestCase(TestCase):
    def setUp(self):
        ...
        self.application = Application.objects.create(user_profile=user_profile,
                                                      client_id="TESTID",
    ...
    def test_authorize_url_logged_in_user_reject(self):
        ...
        resp = self.client.post(reverse("oauth_app_authorize"),
                ...
                "redirect_uri": self.application.redirect_uri})
        self.assertEqual(resp.status_code, 302)
        self.assertEqual(resp["Location"], "%s?%s" %(self.application.redirect_uri,
    ...
    def test_access_token_invalid_client_id(self):
        auth_code = AuthorizationCode.objects.create(application=self.application,
